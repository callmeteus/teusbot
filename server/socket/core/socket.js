	...
	registerListeners() {
		...
		this.on("message", function(data) {
			...
			switch(response.cmd) {
				...
				// Reauth packet
				case 10300003:
					this.handlers.handleAuth(response.Response, response);
				break;

				// Studio enter packet
				case 10300100:
					this.handlers.handleEnter(response.Response, response);
				break;

				// Channel config
				case 10300102:
					this.handlers.handleStudioConfig(response.Response, response);
				break;
			}
		});
	}
